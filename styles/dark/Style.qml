...
StyleBase {
    ...
    readonly property font newH4Font: Qt.font({
        family: fontsInternal.fonts_Headline,
        pixelSize: fontsInternal.typography_Headings_H4,
        letterSpacing: fontsInternal.typography_Headings_H4_letter_spacing,
        weight: Font.Bold
    })
    readonly property font newH5Font: Qt.font({
        family: fontsInternal.fonts_Headline,
        pixelSize: fontsInternal.typography_Headings_H5,
        letterSpacing: fontsInternal.typography_Headings_H5_letter_spacing,
        weight: Font.Bold
    })
    ...
    QtObject {
        ...
        readonly property double typography_Headings_H4: 13
        readonly property double typography_Headings_H4_letter_spacing: 0.62
        readonly property double typography_Headings_H5: 10
        readonly property double typography_Headings_H5_letter_spacing: 0.7
    ...
    readonly property QtObject colors: QtObject {
        readonly property color brand_Basic_Accent: brand_Primary_Medium_light
        readonly property color brand_Basic_Accent_high_contrast: brand_Primary_Light
        ...
        readonly property color brand_Primary_Medium_dark: baseColors.consolinno_Green_600
        readonly property color brand_Primary_Medium_light: baseColors.consolinno_Green_300
        readonly property color brand_Secondary_Accent: baseColors.consolinno_Secondary_Mint
        readonly property color brand_Secondary_Dark: baseColors.consolinno_Gray_800
        readonly property color brand_Secondary_Darker: baseColors.consolinno_Gray_900
        readonly property color brand_Secondary_Darkest: baseColors.consolinno_Gray_950
        readonly property color brand_Secondary_Light: baseColors.consolinno_Gray_300
        readonly property color brand_Secondary_Lighter: baseColors.consolinno_Gray_100
        readonly property color brand_Secondary_Lightest: baseColors.consolinno_Gray_50
        readonly property color brand_Secondary_Medium_dark: baseColors.consolinno_Gray_600
        readonly property color brand_Secondary_Medium_light: baseColors.consolinno_Gray_500
        readonly property color components_Dashboard_Background_accent_dashboard: menu_Header_Footer_Background
        readonly property color components_Dashboard_Background_gradient_bottom: brand_Primary_Dark
        readonly property color components_Dashboard_Background_gradient_top: brand_Secondary_Accent
        readonly property color components_Dashboard_Detail_Energy_circle: brand_Secondary_Accent
        readonly property color components_Dashboard_Detail_Energy_circle_border: baseColors.defaults_Black_and_white_White
        readonly property color components_Dashboard_Detail_Energy_circle_empty: typography_Background_Accent
        readonly property color components_Dashboard_Detail_Energy_circle_glow: baseColors.consolinno_Gray_300
        ...
        readonly property color components_Dynamic_tariff_Bar_charging: components_Statistics_Things_and_states_Battery__3
        readonly property color components_Dynamic_tariff_Bar_charging_fill: components_Statistics_Things_and_states_Battery_1
        readonly property color components_Dynamic_tariff_Bar_default: baseColors.consolinno_Gray_500
        readonly property color components_Dynamic_tariff_Bar_discharging: components_Statistics_Things_and_states_Battery__4
        readonly property color components_Dynamic_tariff_Bar_discharging_fill: components_Statistics_Things_and_states_Battery_
        readonly property color components_Dynamic_tariff_Limit_and_average: typography_Basic_Default
        readonly property color components_Forms_Buttons_Button_border_focus: typography_Background_Default
        readonly property color components_Forms_Buttons_Button_primary: brand_Primary_Medium_light
        readonly property color components_Forms_Buttons_Button_primary_border: brand_Basic_Accent_high_contrast
        readonly property color components_Forms_Buttons_Button_primary_text: brand_Secondary_Darker
        ...
        readonly property color components_Forms_Selection_controls_Unselected: brand_Secondary_Lightest
        readonly property color components_Forms_Slider_Thumb_Track: brand_Basic_Accent_high_contrast
        readonly property color components_Forms_Slider_Thumb_Track_disabled: brand_Secondary_Medium_dark
        readonly property color components_Forms_Slider_Thumb_hover_accent: brand_Primary_Light_12
        readonly property color components_Forms_Slider_Thumb_pressed_accent: brand_Primary_Light_24
        readonly property color components_Forms_Slider_Track_not_selected: brand_Secondary_Medium_light
        readonly property color components_Forms_Toggle_Thumb_Track_inactive: brand_Secondary_Light
        readonly property color components_Forms_Toggle_Thumb_active: typography_Background_Default
        readonly property color components_Forms_Toggle_Thumb_active_disabled: brand_Secondary_Darker
        readonly property color components_Forms_Toggle_Toggle_disabled: brand_Secondary_Medium_dark
        ...
        readonly property color components_Navigation_Slide_indication: baseColors.consolinno_Gray_500
        ...
        readonly property color components_Navigation_Tabs_Text: baseColors.consolinno_Gray_300
        ...
        readonly property color components_Statistics_Legend_pill_text: brand_Secondary_Darkest
        ...
        readonly property color components_Statistics_Things_and_states_Addition_18: baseColors.defaults_Diagram_Fill_20
        readonly property color components_Statistics_Things_and_states_Addition_19: baseColors.defaults_Diagram_Border_20
        readonly property color components_Statistics_Things_and_states_Addition_2: baseColors.defaults_Diagram_Fill_11
        readonly property color components_Statistics_Things_and_states_Addition_20: baseColors.defaults_Diagram_Fill_21
        readonly property color components_Statistics_Things_and_states_Addition_21: baseColors.defaults_Diagram_Border_21
        readonly property color components_Statistics_Things_and_states_Addition_22: baseColors.defaults_Diagram_Fill_22
        readonly property color components_Statistics_Things_and_states_Addition_23: baseColors.defaults_Diagram_Border_22
        ...
        readonly property color components_Statistics_Tooltip_background: baseColors.consolinno_Gray_900_67
        ...
        readonly property color menu_Header_Footer_Background: baseColors.consolinno_Gray_900_67
        readonly property color menu_Header_Footer_Border: typography_Background_Default
        readonly property color system_Danger_Accent: system_Danger_Medium
        readonly property color system_Danger_Background: system_Danger_Darker
        ...
        readonly property color system_Danger_Status_light: system_Danger_Medium
        readonly property color system_Danger_Status_light_border: system_Danger_Darker
        readonly property color system_Neutral_Accent: system_Neutral_Medium
        readonly property color system_Neutral_Background: system_Neutral_Darker
        readonly property color system_Neutral_Dark: baseColors.consolinno_Gray_700
        readonly property color system_Neutral_Darker: baseColors.consolinno_Gray_800
        readonly property color system_Neutral_Light: baseColors.consolinno_Gray_100
        readonly property color system_Neutral_Medium: baseColors.consolinno_Gray_300
        readonly property color system_Neutral_Status_light: system_Neutral_Medium
        readonly property color system_Neutral_Status_light_border: system_Neutral_Darker
        readonly property color system_Success_Accent: system_Success_Medium
        readonly property color system_Success_Background: system_Success_Darker
        ...
        readonly property color system_Success_Status_light: system_Success_Medium
        readonly property color system_Success_Status_light_border: system_Success_Darker
        readonly property color system_Warning_Accent: system_Warning_Medium
        readonly property color system_Warning_Background: system_Warning_Darker
        ...
        readonly property color system_Warning_Status_border: system_Warning_Darker
        readonly property color system_Warning_Status_light: system_Warning_Medium
        readonly property color typography_Background_Accent: baseColors.consolinno_Gray_900
        readonly property color typography_Background_Accent_secondary: baseColors.consolinno_Gray_600
        readonly property color typography_Background_Accent_transparent: baseColors.consolinno_Gray_900_0
        readonly property color typography_Background_Default: baseColors.consolinno_Gray_950
        readonly property color typography_Background_Default_transparent: baseColors.consolinno_Gray_950_0
        readonly property color typography_Background_Overlay: baseColors.consolinno_Gray_50_60
        readonly property color typography_Background_Selection: baseColors.consolinno_Gray_600
        readonly property color typography_Basic_Color_Emphasize: brand_Primary_Light
        readonly property color typography_Basic_Default: brand_Secondary_Lightest
        readonly property color typography_Basic_Default_high_contrast: brand_Secondary_Lightest
        ...
        readonly property color typography_Basic_Secondary: baseColors.consolinno_Gray_300
        ...
        readonly property color typography_States_Hover: baseColors.consolinno_Gray_50_12_5
        readonly property color typography_States_Hover_pressed_outline: typography_States_Pressed
        readonly property color typography_States_Pressed: baseColors.consolinno_Gray_50_25
    }
    ...
    QtObject {
        ...
        readonly property color defaults_Diagram_Border_20: "#ff949494"
        readonly property color defaults_Diagram_Border_21: "#ff878787"
        readonly property color defaults_Diagram_Border_22: "#ff757575"
        ...
        readonly property color defaults_Diagram_Fill_20: "#fffafafa"
        readonly property color defaults_Diagram_Fill_21: "#ffe0e0e0"
        readonly property color defaults_Diagram_Fill_22: "#ffbebebe"
