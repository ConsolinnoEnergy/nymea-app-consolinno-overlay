...
T.Slider {
    ...
    handle: Rectangle {
        ...
        Rectangle {
            ...
            color: control.enabled ?
                       Style.colors.components_Forms_Slider_Thumb_Track :
    ...
    background: Rectangle {
        ...
        implicitWidth: control.horizontal ? 200 : 3
        implicitHeight: control.horizontal ? 3 : 200
        width: control.horizontal ? control.availableWidth : implicitWidth
        height: control.horizontal ? implicitHeight : control.availableHeight
        radius: 4
        color: control.enabled ?
                   Style.colors.components_Forms_Slider_Track_not_selected :
                   Style.colors.components_Forms_Slider_Thumb_Track_disabled
