...
StyleBase {
    ...
    readonly property QtObject colors: QtObject {
        readonly property color brand_Basic_Accent: brand_Primary_Medium_dark
        ...
        readonly property color components_Dashboard_Background_gradient_bottom: brand_Primary_Medium_light
        ...
        readonly property color components_Forms_Selection_controls_Unselected: brand_Secondary_Medium_light
        readonly property color components_Forms_Slider_Thumb_Track: brand_Basic_Accent_high_contrast
        readonly property color components_Forms_Slider_Thumb_Track_disabled: brand_Secondary_Lighter
        readonly property color components_Forms_Slider_Thumb_hover_accent: brand_Primary_Dark_12
        readonly property color components_Forms_Slider_Thumb_pressed_accent: brand_Primary_Dark_24
        readonly property color components_Forms_Slider_Track_not_selected: brand_Secondary_Lighter
        readonly property color components_Forms_Toggle_Thumb_Track_inactive: brand_Secondary_Medium_dark
        readonly property color components_Forms_Toggle_Thumb_active: typography_Background_Default
        readonly property color components_Forms_Toggle_Thumb_active_disabled: brand_Secondary_Lightest
        readonly property color components_Forms_Toggle_Toggle_disabled: brand_Secondary_Lighter
        ...
        readonly property color components_Navigation_Tabs_Text: brand_Secondary_Darker
        ...
        readonly property color typography_Basic_Default: brand_Secondary_Darker
        readonly property color typography_Basic_Default_high_contrast: brand_Secondary_Darkest
