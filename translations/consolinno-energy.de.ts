...
&lt;/div&gt;
    ...
    <message>
        ...
        <translation type="unfinished">(3) Die Kunden sind für das ordnungsgemäße Installieren der Hard- und Software verantwortlich.</translation>
    </message>
    <message>
        <source>(1) %1 grants the customer the exclusive right to use the software described in more detail in the agreement within Germany. A non-exclusive and non-transferable right to use the software is granted.</source>
        <translation type="unfinished">(1) %1 gewährt dem Kunden das ausschließliche Recht die in der Vereinbarung näher beschriebene Software innerhalb Deutschlands zu nutzen. Es wird ein nicht-ausschließliches und nicht-übertragbares Nutzungsrecht an der Software eingeräumt.</translation>
    </message>
    <message>
        <source>(2) The software may be reproduced to the extent necessary for the contractual use.</source>
        <translation type="unfinished">(2) Soweit dies für die vertragsgemäße Nutzung erforderlich ist, darf die Software vervielfältigt werden.</translation>
    </message>
    <message>
        <source>The customer can download and install the program using the respective operating system via the app stores.</source>
        <translation type="unfinished">Über die Appstores kann der Kunde mit dem jeweiligen Betriebssystem das Programm laden und installieren.</translation>
    </message>
    <message>
        <source>(3) Furthermore, the customer is not entitled to copy or transfer the software to third parties, unless otherwise provided by law.</source>
        <translation type="unfinished">(3) Im Übrigen ist der Kunde zu einer Vervielfältigung oder Überlassung an Dritte nicht berechtigt, soweit gesetzlich nicht anderes bestimmt.</translation>
    </message>
    <message>
        <source>(4) The customer is not entitled to change or edit the software unless the change or editing is necessary to eliminate a defect that is necessary for the contractual use of the software and with which %1 is in default.</source>
        <translation type="unfinished">(4) Der Kunde ist nicht berechtigt, die Software zu verändern und zu bearbeiten, es sei denn, es handelt sich bei der Änderung bzw. Bearbeitung um eine für die vertragsgemäße Nutzung der Software erforderliche Beseitigung eines Mangels, mit welcher sich die %1 in Verzug befindet.</translation>
    </message>
    <message>
        <source>3.License fee</source>
    ...
    <message>
        <source>4.Software delivery and installation</source>
        <translation type="unfinished">4.Softwareauslieferung und Installation</translation>
    </message>
    <message>
        <source>(1) %1 delivers the software to the customer via the Apple or Google app store.</source>
    ...
    <message>
        ...
        <translation type="unfinished">(2) %1 ist zu einer Änderung, Anpassung und Weiterentwicklung der Software nur dann verpflichtet, wenn das mit dem Kunden gesondert vereinbart ist. Ohne eine solche gesonderte Vereinbarung ist die %1 nicht zu einer Weiterentwicklung der Software verpflichtet.</translation>
    </message>
    <message>
        <source>6.Warranty</source>
        <translation type="unfinished">6. Gewährleistung</translation>
    </message>
    <message>
        <source>(1) If the customer discovers defects in the software, the device or the documentation, the customer must inform %1. This can be done, for example, by email.</source>
        <translation type="unfinished">(1) Sollte dem Kunden Mängel an der Software, am Gerät oder an der Dokumentation feststellen, so hat der Kunde das der %1 mitzuteilen. Das kann zum Beispiel per Mail erfolgen.</translation>
    </message>
    <message>
        <source>(2) A defect does not exist if the hardware and/or software used by the customer does not meet the specified requirements.</source>
        <translation type="unfinished">(2) Ein Mangel liegt nicht vor, wenn die vom Kunden verwendete Hardware und /oder Software nicht den spezifizierten Anforderungen entspricht.</translation>
    </message>
    <message>
        <source>(3) %1 will remedy the reported defects in the software and documentation within a reasonable period of time. When remedying the defect, %1 has the right to choose between repair and replacement delivery. %1 will bear the costs of remedying the defect. Costs for downtime, lost profits, installation and removal costs or similar will not be reimbursed.</source>
        <translation type="unfinished">(3) %1 wird die angezeigten Mängel an der Software und an der Dokumentation innerhalb einer angemessenen Frist zu beheben. Im Rahmen der Mängelbeseitigung hat %1 ein Wahlrecht zwischen Nachbesserung und Ersatzlieferung. Die Kosten der Mängelbeseitigung trägt %1. Kosten für Ausfall, entgangener Gewinn, Ein- und Ausbaukosten oder ähnliches werden nicht erstattet.</translation>
    </message>
    <message>
        <source>(4) If the remedy of defects owed here fails, the customer is entitled to extraordinary termination of the contract in question in accordance with Section 543 Paragraph 2 Sentence 1 No. 1 of the German Civil Code (BGB).</source>
        <translation type="unfinished">(4) Schlägt die hierin geschuldete Mängelbeseitigung fehl, ist die Kunde zur außerordentlichen Kündigung des betreffenden Vertrages gemäß § 543 Abs. 2 S. 1 Nr. 1 BGB berechtigt.</translation>
    </message>
    <message>
        <source>8. Liability</source>
        <translation type="unfinished">8. Haftung</translation>
    </message>
    <message>
        <source>(1) The licensor is liable without limitation:
...
· in accordance with the provisions of the Product Liability Act</source>
        <translation type="unfinished">(1) Der Lizenzgeber haftet unbeschränkt:
...
· nach den Vorschriften des Produkthaftungsgesetzes</translation>
    </message>
    <message>
        <source>(2) Furthermore, %1’s liability for direct and indirect damages is excluded.</source>
        <translation type="unfinished">(2) Im Übrigen ist eine Haftung der %1 für direkte und indirekte Schäden ausgeschlossen.</translation>
    </message>
    <message>
        <source>(3) Open Source

Open source modules are included in the APP and in the device software. The corresponding guarantee and liability conditions apply to these modules. If this is not possible, the regulations in the respective user country apply.</source>
        <translation type="unfinished">(3) Open Source

Open Source Module sind in der APP und in der Gerätesoftware enthalten. Es gelten für diese Module die entsprechende Garantie und Haftungsbedingungen. Sollte das nicht möglich sein, dann gilt die Regelung im jeweiligen Anwenderland.</translation>
    </message>
    <message>
        <source>9. Contract duration and termination</source>
        <translation type="unfinished">9.Vertragsdauer und Vertragsbeendigung</translation>
    </message>
    <message>
        <source>(1) The license agreement comes into force upon acceptance of the license terms prior to installation and is valid for an indefinite period.</source>
        <translation type="unfinished">(1) Der Lizenzvertrag tritt mit der Akzeptanz der Lizenzbestimmungen vor der Installation in Kraft in gilt auf unbestimmte Dauer.</translation>
    </message>
    <message>
        <source>(2) The right of both parties to terminate the contract at any time for good cause and without notice remains unaffected. Good cause exists in particular if the licensor or licensee intentionally or negligently violates a material obligation under these license terms and conditions and the terminating party can therefore no longer reasonably be expected to adhere to the license agreement. The licensor is therefore entitled to terminate the license agreement for good cause and without notice if the licensee exceeds the rights of use granted to it and does not stop its infringements within a reasonable period of time, if the licensor has previously warned the licensee to refrain from these infringements.</source>
        <translation type="unfinished">(2) Das Recht beider Parteien zur jederzeitigen außerordentlichen und fristlosen Kündigung aus wichtigem Grund bleibt unberührt. Ein wichtiger Grund liegt insbesondere vor, wenn der Lizenzgeber oder die Lizenznehmerin vorsätzlich oder fahrlässig gegen eine wesentliche Pflicht aus diesen Lizenzbestimmungen verstößt und deswegen der kündigenden Partei das Festhalten am Lizenzvertrag nicht mehr zumutbar ist. Der Lizenzgeber ist hiernach insbesondere zur außerordentlichen und fristlosen Kündigung des Lizenzvertrages berechtigt, wenn die Lizenznehmerin die ihr eingeräumten Nutzungsbefugnisse überschreitet und ihre Verletzungshandlungen nicht innerhalb einer angemessenen Frist abstellt, wenn der Lizenzgeber diese zuvor zur Unterlassung dieser Verletzungshandlungen abgemahnt hat.</translation>
    </message>
    <message>
        <source>(3) Termination of the License Agreement must be in writing.</source>
        <translation type="unfinished">(3) Die Kündigung des Lizenzvertrages bedarf der Schriftform.</translation>
    </message>
    <message>
        <source>(4) %1 may stop maintaining the program without giving reasons</source>
        <translation type="unfinished">(4) %1 kann die Pflege des Programmes ohne nennen von Gründen einstellen</translation>
    </message>
    <message>
        <source>11. Final provisions</source>
        <translation type="unfinished">11. Schlussbestimmungen</translation>
    </message>
    <message>
        <source>(1) Should one of these license terms or a provision later included in this license agreement be or become invalid or unenforceable in whole or in part, or should a gap in these license terms emerge, the validity of the remaining provisions shall not be affected thereby (preservation). It is the express intention of the parties to maintain the validity of the remaining provisions under all circumstances and thus to waive Section 139 of the German Civil Code (BGB) in its entirety. Instead of the invalid or unenforceable provision or to fill the gap, the effective and enforceable provision shall be deemed to have been determined with retroactive effect, which legally and economically comes closest to what the parties wanted or would have wanted according to the spirit and purpose of the license agreement if they had considered this point when concluding this agreement or when including the provision; if the invalidity of a provision is based on a level of performance or time (deadline or date) specified therein, the provision shall be deemed to have been agreed with a legally permissible level that comes closest to the original level (fiction of replacement). If the fiction of replacement is not possible, a provision or regulation must be made in place of the invalid or unenforceable provision or to close the gap in accordance with the content of the previous sentence (obligation to replace). If the invalidity or gap concerns a provision that requires notarization, the regulation or provision must be agreed in notarized form.</source>
        <translation type="unfinished">(1) Sollte eine dieser Lizenzbestimmungen oder eine später in diesen Lizenzvertrag aufgenommene Bestimmung ganz oder teilweise nichtig oder undurchführbar sein oder werden oder sollte sich eine Lücke in diesen Lizenzbestimmungen herausstellen, wird dadurch die Wirksamkeit der übrigen Bestimmungen nicht berührt (Erhaltung). Es ist der ausdrückliche Wille der Parteien, hierdurch die Wirksamkeit der übrigen Bestimmungen unter allen Umständen aufrechtzuerhalten und damit § 139 BGB insgesamt abzubedingen. Anstelle der nichtigen oder undurchführbaren Bestimmung oder zur Ausfüllung der Lücke gilt mit Rückwirkung diejenige wirksame und durchführbare Regelung als bestimmt, die rechtlich und wirtschaftlich dem am nächsten kommt, was die Parteien gewollt haben oder nach dem Sinn und Zweck des Lizenzvertrages gewollt hätten, wenn sie diesen Punkt bei Abschluss dieser Vereinbarung bzw. bei Aufnahme der Bestimmung bedacht hätten; beruht die Nichtigkeit einer Bestimmung auf einem darin festgelegten Maß der Leistung oder der Zeit (Frist oder Termin), so gilt die Bestimmung mit einem dem ursprünglichen Maß am nächsten kommenden rechtlich zulässigen Maß als vereinbart (Ersetzungsfiktion). Ist die Ersetzungsfiktion nicht möglich, ist anstelle der nichtigen oder undurchführbaren Bestimmung oder zur Schließung der Lücke eine Bestimmung bzw. Regelung nach inhaltlicher Maßgabe des vorstehenden Satzes zu treffen (Ersetzungsverpflichtung). Betrifft die Nichtigkeit oder Lücke eine beurkundungspflichtige Bestimmung, so ist die Regelung bzw. die Bestimmung in notariell beurkundeter Form zu vereinbaren.</translation>
    </message>
    <message>
        <source>(2) Any amendments or additions to the relevant licence agreement, including this clause, must be made in writing unless otherwise specified.</source>
        <translation type="unfinished">(2) Änderungen und Ergänzungen des betreffenden Lizenzvertrages einschließlich dieser Klausel bedürfen der Schriftform, soweit nicht etwas anderes bestimmt ist.</translation>
    </message>
    <message>
        <source>(3) The parties may only transfer the License Agreement and any rights and obligations arising from the License Agreement to a third party with the prior written consent of the other party.</source>
        <translation type="unfinished">(3) Die Parteien dürfen den Lizenzvertrag sowie Rechte und Pflichten aus dem Lizenzvertrag nur mit vorheriger schriftlicher Zustimmung der jeweils anderen Partei auf einen Dritten übertragen.</translation>
    </message>
    <message>
        <source>(4) The validity of the licensee’s general terms and conditions is expressly excluded.</source>
        <translation type="unfinished">(4) Die Geltung der Allgemeinen Geschäftsbedingungen der Lizenznehmer/in werden ausdrücklich ausgeschlossen.</translation>
    </message>
    <message>
        <source>(5) The exclusive place of jurisdiction for all disputes arising from or in connection with the license agreement is the registered office of the licensor, Regensburg. The licensor remains entitled to bring an action at the general place of jurisdiction of the licensee.</source>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Sollte die Wärmepumpe weniger Überschuss verbrauchen als erwartet, bitten Sie Ihren Installateur die Einstellungen zu prüfen.</translation>
    </message>
</context>
<context>
    <name>S:</name>
