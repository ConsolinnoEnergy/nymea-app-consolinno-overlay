    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Label {
                ...
                visible: heatpumpThing ? heatpumpThing.stateByName(
                                             "currentPower") : false
            }
        ...
        Repeater {
            ...
            model: [{
                    ...
                    "value": translateNymeaHeatpumpValues(
                                 heatpumpThing.stateByName(
                                     "sgReadyMode") ? heatpumpThing.stateByName(
                                                          "sgReadyMode").value : null),
                    "component": stringValues,
                    "unit": ""
                }, {
                    "Id": "outdoorTemperature",
                    "name": qsTr("Outdoor temperature"),
                    "value": heatpumpThing.stateByName(
                                 "outdoorTemperature") ? heatpumpThing.stateByName(
                                                             "outdoorTemperature").value : null,
                    "unit": "°C",
                    "component": stringValues
                }, {
                    "Id": "hotWaterTemperature",
                    "name": qsTr("Hot water temperature"),
                    "value": heatpumpThing.stateByName(
                                 "hotWaterTemperature") ? heatpumpThing.stateByName(
                                                              "hotWaterTemperature").value : null,
                    "unit": "°C",
                    "component": stringValues
                }, {
                    ...
                    "value": heatpumpThing.stateByName(
                                 "returnTemperature") ? heatpumpThing.stateByName(
                                                            "returnTemperature").value : null,
                    "unit": "°C",
                    "component": stringValues
                }, {
                    "Id": "flowTemperature",
                    ...
                    "value": heatpumpThing.stateByName(
                                 "flowTemperature") ? heatpumpThing.stateByName(
                                                          "flowTemperature").value : null,
                    "unit": "°C",
                    "component": stringValues
                }]
                    ...
                    Repeater {
                        ...
                        delegate: ItemDelegate {
                            ...
                            contentItem: RowLayout {
                                ...
                                Label {
                                    Layout.minimumWidth: app.width - 2 * app.margins
                                                         - itemValue.contentWidth - itemUnit.width
                                    id: itemLabel
                                    text: modelData.name
                                }
