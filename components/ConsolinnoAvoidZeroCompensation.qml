    ...
    ColumnLayout {
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                var popup = dialog.createObject(app, {headerText: qsTr("Avoid zero compensation"), text: text, source: Qt.locale("de_DE") ? "../images/avoidZeroCompansationExample_de.svg" : "../images/avoidZeroCompansationExample_en.svg"})
                popup.open();
            }
        }
